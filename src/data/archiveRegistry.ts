...
export const archiveRegistry: ArchiveAsset[] = [
  ...
  },
  {
    ...
    url: "",
    description: "Research signal record for Duga, radar, and aurora systems.",
    signalStrength: 66,
    format: "REFERENCE",
    access: "PENDING",
    archiveLabel: "INPUT",
    transmissionNote: "Radar archaeology thread in source review.",
    action: "VIEW ARCHIVE",
  },
  {
    ...
    url: "",
    description: "Image study for model images, drawings, and failed tests.",
    signalStrength: 49,
    format: "IMAGE SET",
    access: "LOCKED",
    archiveLabel: "PROCESS",
    transmissionNote: "Material evidence is presented as a trace rather than a complete record.",
    action: "VIEW ARCHIVE",
  },
  {
    ...
    access: "LOCKED",
    archiveLabel: "PROCESS",
    transmissionNote: "Subterranean image sequence in development.",
    action: "VIEW ARCHIVE",
  },
  {
    id: "timeline-dossier",
